...
use Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UpgrateFileData as DataArea;
class UpgrateFileData extends  Frame
{
    CONST OPERATOR=1008;

    /**
     * @var Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UpgrateFileData
     */
    private $dataArea;
    ...
    /**
     * @param \Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UpgrateFileData $dataArea
     */
