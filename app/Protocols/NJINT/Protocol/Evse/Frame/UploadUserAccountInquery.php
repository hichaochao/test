...
use Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UploadUserAccountInquery as DataArea;
class UploadUserAccountInquery extends Frame
{
    CONST OPERATOR=204;

    /**
     * @var Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UploadUserAccountInquery
     */
    private $dataArea;
    ...
    /**
     * @param \Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UploadUserAccountInquery $dataArea
     */
