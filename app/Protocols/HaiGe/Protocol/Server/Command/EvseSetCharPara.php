<?php
namespace NJ_INT\Server\Command;
use Protocols\Tools;
use NJ_INT\Base\MY_Tools;
/**
 * Created by PhpStorm.
 * User: Jihailiang
 * Date: 2016/6/16
...
class EvseSetCharPara
{
    ...
    private function getCmdArgs(){
        ...
        for($i=$this->cmdStartPosition;$i<=$this->cmdEndPosition;$i++){
            ...
            //var_dump( __CLASS__."/".__FUNCTION__."@".__LINE__." tmp:$tmp " );DIE;
            if(-1==$tmp){
                break;
            }
...
//        $cmdFrame = [0x36,0x30,0x0,0x0];
     ...
     */
    public function setQRCode($argQRCode)
    {
        //$this->argStopCharge = $argStopCharge;
        $this->cmdArgsArray[7] =$argQRCode;
    ...
    public function build()
    {
        ...
        //var_dump($cmdFrame);
        //var_dump( __CLASS__."/".__FUNCTION__."@".__LINE__." cmd length:". $this->getCmdLength());
