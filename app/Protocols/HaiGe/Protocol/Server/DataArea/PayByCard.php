...
class PayByCard
{
     ...
     * @return int
     */
    public function getUserCarDeffective()
    {
        return $this->userCarDeffective;
    }

    /**
     * @param int $userCarDeffective
     */
    public function setUserCarDeffective($userCarDeffective)
    {
        $this->userCarDeffective = $userCarDeffective;
    }
    ...
    public function build(){
        ...
        array_push($frame, $this->userCarDeffective);//用户卡号是否有效
        return $frame;
    }
    ...
    public function load($dataArea){
        ...
        $offset = $offset+10;
        $this->userCarDeffective = $dataArea[$offset];
        $offset++;
