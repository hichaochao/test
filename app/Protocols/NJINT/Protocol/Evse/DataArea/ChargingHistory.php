...
class ChargingHistory extends DataArea
{
    ...
    public function __construct()
    {
        ...
        $this->reserved21=[0x00,0x00,0x00,0x00];
        $this->reserved22=[0x00,0x00,0x00,0x00];
        $this->reserved23=0x00;
     ...
     * @return mixed
     */
    public function getNowLogIndex()
    {
        return $this->nowLogIndex;
    }

    /**
     * @param mixed $nowLogIndex
     */
    public function setNowLogIndex($nowLogIndex)
    {
        $this->nowLogIndex = $nowLogIndex;
    }
     ...
     * @return mixed
     */
    public function getReserved22()
    {
        return $this->reserved22;
    }

    /**
     * @param mixed $reserved22
     */
    public function setReserved22($reserved22)
    {
     ...
     * @return mixed
     */
    public function getReserved23()
    {
        return $this->reserved23;
    }

    /**
     * @param mixed $reserved23
     */
    public function setReserved23($reserved23)
    {
    ...
    public function build(){
        ...
        $frame =array_merge($frame,Tools::decToArray($this->nowLogIndex,4));
        ...
        $frame=array_merge($frame,$this->reserved21);
        $frame=array_merge($frame,$this->reserved22);
        array_push($frame,$this->reserved23);
    ...
    public function load($dataArea){
        ...
        $this->nowLogIndex = Tools::arrayToDec(array_slice($dataArea,$offset,4));
        $offset+=4;
        ...
        $this->reserved21 =array_slice($dataArea,$offset,4);
        $offset+=4;

        $this->reserved22 =array_slice($dataArea,$offset,4);
        $offset+=4;

        $this->reserved23 =  $dataArea[$offset];
        $offset+=1;
        ...
        $this->carVIN = Tools::decArrayToAsciiString(array_slice($dataArea,$offset,17));
        $offset+=17;

        $this->carPlateNumber = Tools::arrayToDec(array_slice($dataArea,$offset,8));
        $offset+=8;
