...
class Get24HsCommodityStrategy
{
    ...
    public function build(){
        ...
        $frame =array();
        $frame = array_merge($frame,Tools::decToArray($this->commodityOne,2)); //充电后电表读数
        $frame = array_merge($frame,Tools::decToArray($this->commodityTwo,2)); //充电后电表读数
        $frame = array_merge($frame,Tools::decToArray($this->commodityThree,2)); //充电后电表读数
        $frame = array_merge($frame,Tools::decToArray($this->commodityFour,2)); //充电后电表读数
        $frame = array_merge($frame,Tools::decToArray($this->serviceCharge,2)); //充电后电表读数
        $frame = array_merge($frame,Tools::decToArray($this->implement,48,false)); //充电后电表读数
        return $frame;
    }
