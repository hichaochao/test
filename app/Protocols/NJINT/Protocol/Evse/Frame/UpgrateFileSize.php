...
use Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UpgrateFileSize as DataArea;
class UpgrateFileSize extends  Frame
{
    CONST OPERATOR=1006;

    /**
     * @var Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UpgrateFileSize
     */
    private $dataArea;
    ...
    /**
     * @param \Wormhole\Protocols\NJINT\Protocol\Evse\DataArea\UpgrateFileSize $dataArea
     */
